  ...
  const categories = [
    ...
    },
    {
      ...
      articles: [
        ...
        { title: "Directors and Officers Guide to Navigating AI-Related Risks", source: "Aon Financial Services Group", date: "2024", url: "https://www.aon.com/en/insights/articles/directors-and-officers-guide-to-navigating-ai-related-risks", quote: "Many of these incidents involve firms touting AI capabilities. Later, it's allegedly revealed that the AI is not as developed as articulated.", summary: "Aon maps three categories of D&O AI exposure: securities class actions tied to AI capability misrepresentations, regulatory claims under the EU AI Act and Colorado AI Act, and shareholder derivative lawsuits alleging board oversight failures. Side A D&O coverage is flagged as critical given the non-indemnifiable nature of most derivative settlements. The report also recommends companies augment definitions of \"loss\" and \"insured person\" in their D&O policies to optimize coverage for AI-related exposures." },
        { title: "The Growing Use of Artificial Intelligence: D&O Risks and Potential Coverage Solutions", source: "Aon Financial Services Group", date: "Apr 2024", url: "https://www.aon.com/risk-services/financial-services-group/the-growing-use-of-artificial-intelligence-d-and-o-risks-and-potential-coverage-solutions", quote: "On March 18, 2024, the SEC announced 'AI washing' settlements with two investment advisors that paid a collective $400,000 in civil penalties.", summary: "Over 40% of S&P 500 companies mentioned AI in their most recent annual SEC filings, making \"AI washing\" a top regulatory concern. SEC Chair Gary Gensler has signaled aggressive enforcement against false AI disclosures, modeling the playbook on greenwashing cases. Aon's coverage approach centers on augmenting key D&O policy terms (including \"Loss\" and \"Insured Person\") and tightening typical exclusionary language to ensure AI exposures are properly addressed." },
      ],
    },
    {
            ...
            return (
              <div key={artIdx} style={{ borderBottom: "1px solid #E5E7EB" }}>
                <button onClick={() => setExpanded(isOpen ? null : key)} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ color: NAVY, fontSize: 16, fontWeight: 600, lineHeight: 1.4, marginBottom: 4 }}>{article.title}</div>
                ...
                {isOpen && (
                  <div style={{ paddingBottom: 20 }}>
                    <div style={{ background: LGOLD, borderRadius: 8, padding: "12px 16px", borderLeft: `3px solid ${GOLD}`, marginBottom: 16 }}>
